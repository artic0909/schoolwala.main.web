...
@section('content')
                      ...
                      <div class="d-flex justify-content-center">
                        <div class="d-flex justify-content-center align-items-center mt-3">
                          ...
                          <form action="" method="GET" class="d-flex align-items-center">
                            <input type="number" name="page" value="{{ $chapters->currentPage() }}" min="1"
                              max="{{ $chapters->lastPage() }}" class="form-control text-center me-1" style="width: 70px;"
  ...
  <!-- Edit Chapter Modal -->
  @foreach($chapters as $chapter)
    <div class="modal fade" id="backDropModalEditClass{{ $chapter->id }}" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col mb-3">
                ...
                <select name="class_id" id="class_id_edit{{ $chapter->id }}" class="form-select class-select"
                  data-chapter-id="{{ $chapter->id }}" data-selected-class="{{ $chapter->class_id }}"
            ...
            <div class="row">
              <div class="col mb-3">
                ...
                <select name="subject_id" id="subject_id_edit{{ $chapter->id }}" class="form-select subject-select">
  ...
  @foreach($chapters as $chapter)
    <div class="modal fade" id="backDropModalDeleteClass{{ $chapter->id }}" data-bs-backdrop="static" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
