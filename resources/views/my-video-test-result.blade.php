...
@section('title',  $chapter->name . ' - ' . $subject->name . ' - ' . $class->name . ' - ')
    ...
    <form id="practiceTestForm">
        ...
        <div class="progress-container">
            ...
            <div class="progress-header">
                ...
                <div class="progress-title"><a href="{{ route('student.my-chapter-videos', ['classId' => $class->id,'subjectId'=> $subject->id,'chapterId' => $chapter->id]) }}">Back</a></div>
            </div>
